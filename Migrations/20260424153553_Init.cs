        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerEmail = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    ...
                    ShippingCity = table.Column<string>(type: "TEXT", maxLength: 80, nullable: true),
                    ShippingDepartment = table.Column<string>(type: "TEXT", maxLength: 80, nullable: true),
                    ShippingPostalCode = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    Notes = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ShippingZone = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComparePrice = table.Column<decimal>(type: "decimal(12,2)", nullable: true),
                    ...
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    SizesCsv = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    ColorsCsv = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Alt = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
